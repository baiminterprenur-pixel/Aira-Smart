export default async function handler(req, res) {
  ...
  const customResponses = [
    ...
    {
      keywords: [
        "buat surat keterangan usaha","mau buat surat keterangan usaha","bisa bantu buat surat keterangan usaha","aku mau bikin surat keterangan usaha",
        "cara buat surat keterangan usaha","minta buatkan surat keterangan usaha","buat surat keterangan keterangan usaha","surat keterangan usaha dong",
        "mau urus surat keterangan usaha","tolong buat surat keterangan usaha","saya ingin membuat surat keterangan usaha","saya mau buat surat keterangan usaha",
        "bantu bikin surat keterangan usaha","pengajuan surat keterangan usaha","permohonan surat keterangan usaha","surat keterangan usaha penduduk",
        "buatkan surat keterangan usaha saya","mau bikin surat keterangan keterangan usaha","aku ingin buat surat keterangan usaha","bisa bikin surat keterangan usaha ga",
        "mau minta surat keterangan usaha","urus keterangan usaha","bikin keterangan usaha","surat keterangan usaha","keterangan usaha","buat surat keterangan usaha sekarang",
        "aku perlu surat keterangan usaha","mau buat surat tempat tinggal","buat surat tempat tinggal","surat keterangan tempat tinggal",
        "mau bikin surat tempat tinggal","izin buat surat keterangan usaha","minta surat keterangan tempat tinggal","bantu urus keterangan usaha",
        "saya perlu surat keterangan usaha","surat keterangan usaha warga","buat surat keterangan usaha online","pengurusan surat keterangan usaha",
        "mau cetak surat keterangan usaha","pengajuan keterangan usaha","buatkan keterangan usaha penduduk","surat keterangan usaha pribadi",
        "surat keterangan usaha untuk kerja","surat keterangan usaha untuk sekolah","surat keterangan usaha untuk bank","surat keterangan usaha usaha",
        "buat surat keterangan usaha usaha","mau bikin surat keterangan usaha usaha","surat keterangan keterangan usaha usaha","sku","buat sku","mau buat sku"
      ],
      reply: `Oke, silakan isi datamu jika ingin buat surat keterangan usaha di link berikut:<br><br><a href="https://docs.google.com/forms/d/e/1FAIpQLSfwKiGjCUQaAbebp0khcr0eKGYHKwNdnmKfYmMaq_6NLE6yfw/viewform?usp=header">📄 Form Surat Keterangan usaha Desa Mekar Sari</a>`
    }
  ];
