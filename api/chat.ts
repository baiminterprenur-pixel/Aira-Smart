  ...
  const customResponses = [
    ...
    // 📄 SURAT DOMISILI
    {
      keywords: [
        ...
        "aku mau bikin surat domisili","cara buat surat domisili","minta buatkan surat domisili","buat surat keterangan domisili",
        "surat domisili dong","mau urus surat domisili","tolong buat surat domisili","saya ingin membuat surat domisili",
        "saya mau buat surat domisili","bantu bikin surat domisili","pengajuan surat domisili","permohonan surat domisili",
        "surat domisili penduduk","buatkan surat domisili saya","mau bikin surat keterangan domisili","aku ingin buat surat domisili",
        "bisa bikin surat domisili ga","mau minta surat domisili","urus domisili","bikin domisili","surat domisili","domisili",
        "buat surat domisili sekarang","aku perlu surat domisili","mau buat surat tempat tinggal","buat surat tempat tinggal",
        "surat keterangan tempat tinggal","mau bikin surat tempat tinggal","izin buat surat domisili","minta surat keterangan tempat tinggal",
        "bantu urus domisili","saya perlu surat domisili","surat domisili warga","buat surat domisili online","pengurusan surat domisili",
        "mau cetak surat domisili","pengajuan domisili","buatkan domisili penduduk","surat domisili pribadi","surat domisili untuk kerja",
        "surat domisili untuk sekolah","surat domisili untuk bank","surat domisili usaha","buat surat domisili usaha",
        "mau bikin surat domisili usaha","surat keterangan domisili usaha","skdu","buat skdu","mau buat skdu"
      ],
